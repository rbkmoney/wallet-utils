import { Direction, GoToFormInfo, SavePassportCompleted, SavePassportFailed, SavePassportRequested, TypeKeys } from 'app/actions';
import { call, CallEffect, ForkEffect, put, PutEffect, select, SelectEffect, takeLatest } from 'redux-saga/effects';
import { InsuranceFormInfo, State } from 'app/state';
import { saveDocument } from 'app/backend';

type SavePutEffect = SavePassportCompleted | SavePassportFailed | GoToFormInfo;
